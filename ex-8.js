...
// Start coding here
function extractTotalPaidByLocation(bills) {
  return bills.reduce((result, bill) => {
    !result[bill.location]
      ? (result[bill.location] = bill.total)
      : (result[bill.location] += bill.total);
    return result;
  }, []);
}

const totalPaidByLocation = extractTotalPaidByLocation(bills);
